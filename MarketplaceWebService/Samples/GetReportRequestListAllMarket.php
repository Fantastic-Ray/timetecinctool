...
// 
invokeGetReportRequestList($service, $request,$requestID,$reportType);
...
/**
  ...
  */
  function invokeGetReportRequestList(MarketplaceWebService_Interface $service, $request,$requestID,$reportType) 
  {
                    ...
                    foreach ($reportRequestInfoList as $reportRequestInfo) {
                        ...
                        if ($reportRequestInfo->isSetReportRequestId()) 
                          ...
                          if ($reportRequestInfo->isSetReportType()) 
                          {
                             ...
                             if( $reportRequestInfo->getReportType() == $reportType){
